# pygame has a sprite class
# sprite class contains a surface and a rect; it can be drawn and updated very easily
# We are going to create a sprite class for the player and each of the obstacles.
...
class Player(pygame.sprite.Sprite): # It has a Sprite inheritance.
    ...
    def __init__(self):
        ...
        self.rect = self.image.get_rect(midbottom = (200,300)) # We have created the image's rectangle
