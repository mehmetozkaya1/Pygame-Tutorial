# Char and enemy and screen animations
...
player_walk1 = pygame.image.load('C:/Users/PANTHER/OneDrive/Masaüstü/SoftwareLessons/Apps/Pygame/ClearCode/graphics/Player/player_walk_1.png').convert_alpha() # We created a player surface. And converted it.
player_walk2 = pygame.image.load('C:/Users/PANTHER/OneDrive/Masaüstü/SoftwareLessons/Apps/Pygame/ClearCode/graphics/Player/player_walk_2.png').convert_alpha() # We created a player surface. And converted it.
...
player_jump = pygame.image.load('C:/Users/PANTHER/OneDrive/Masaüstü/SoftwareLessons/Apps/Pygame/ClearCode/graphics/Player/jump.png').convert_alpha()
        ...
        if game_active: # If the game is active, I check all timers at the same time.
            if event.type == obstacle_timer: # If our event is obstacle_timer which is triggered every 900 ms and game is active.
                if randint(0,2): # It will give us 0 or 1. If true it will give us a snail. If it is false it will give us a fly
                    obstacle_rect_list.append(snail_surf.get_rect(bottomright = (randint(900,1100),300))) # Every time the timer triggers we are adding a new snail rect to the list with random coordinates.
                else:
